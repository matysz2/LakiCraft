...
const StatsPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchPaymentStats = async () => {
      try {
        const response = await fetch(`${BASE_URL}/api/stats/payment`);
    ...
    const fetchSalesStats = async () => {
      try {
        const response = await fetch(`${BASE_URL}/api/stats/sales`);
        const data = await response.json();
        setSalesStats(data);
      } catch (error) {
    ...
    const fetchPaintingStats = async () => {
      try {
        const response = await fetch(`${BASE_URL}/api/stats/painting`);
        const data = await response.json();
    ...
    const fetchLacquerOrdersCount = async () => {
      try {
        const response = await fetch(`${BASE_URL}/api/stats/lacquer-orders-count`);
        const data = await response.json();
    ...
    const fetchPaintingOrderStatuses = async () => {
      try {
        const response = await fetch(`${BASE_URL}/api/stats/painting-statuses`);
        const data = await response.json();
    ...
    const fetchSalesOrderStatuses = async () => {
      try {
        const response = await fetch(`${BASE_URL}/api/stats/sales-statuses`);
        const data = await response.json();
